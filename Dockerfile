...
# 3. Abilita il modulo rewrite di Apache e imposta la ServerName (Evita i warning di Apache su Alpine)
...
# 6. Imposta i permessi corretti per Apache (su Alpine l'utente di Apache si chiama apache, non www-data)
