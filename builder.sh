...
docker stop aegis-ca && docker rm aegis-ca && docker build -t aegis-ca-local . && docker run -dit --name aegis-ca -v /home/lorenzo/Documenti/GitHubProjects/AegisCA/web-ui:/var/www/localhost/htdocs/ aegis-ca-local