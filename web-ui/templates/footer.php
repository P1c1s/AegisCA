...
<div class="footer">
    <div class="footer-meta">
        ...
        <p class="version">
            <a href="https://github.com/P1c1s/AegisCA/releases/tag/v<?php echo APP_VERSION; ?>" target="_blank" rel="noopener">v<?php echo APP_VERSION; ?></a> &bull; Licenza Apache            <?php if ($hasUpdate): ?>
