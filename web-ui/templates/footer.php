...
<div class="footer">
    <div class="footer-meta">
        <p>
            ...
            &bull; <?= __('footer_developed_by', 'Developed by') ?> <a href="https://github.com/P1c1s" target="_blank" rel="noopener">P1c1s</a>
        </p>
        
        <p class="version">
            <a href="https://github.com/P1c1s/AegisCA/releases/tag/v<?php echo APP_VERSION; ?>" target="_blank" rel="noopener">v<?php echo APP_VERSION; ?></a> &bull; <?= __('footer_license', 'Apache License') ?>
            <?php if ($hasUpdate): ?>
                &bull; <a href="https://github.com/P1c1s/AegisCA/releases/latest" target="_blank" rel="noopener" class="update-badge">
                    <i class="fa-solid fa-circle-arrow-up"></i> <?= sprintf(__('footer_new_version_available', 'New version available (v%s)'), htmlspecialchars($latestVersion)) ?>
                </a>
            <?php endif; ?>
        </p>
    </div>
